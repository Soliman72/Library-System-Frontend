  ...
  <div class="layout">
    <aside class="sidebar glass-panel">
      ...
      <nav class="nav-menu">
        ...
        <router-link to="/member/catalog" class="nav-item">Catalog</router-link>
        <router-link to="/member/borrows" class="nav-item">My Borrows</router-link>
        <router-link to="/member/profile" class="nav-item">Profile</router-link>
      </nav>
...
const initials = computed(() => {
  return authStore.user?.name?.substring(0, 2).toUpperCase() || 'MB'
})
